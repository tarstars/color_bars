...
urlpatterns = [
    ...
    path('pictures/<str:picture_name>', views.return_picture, name='return_picture'),
    ...
    path('welcome/select_picture/welcome/train_picture/<str:user_name>/<str:picture_name>/<str:initial_permutation>/<str:color_bars>',
